...
APPLE_PTX_BRIDGE="$PROJECT_DIR/hetgpu-ios/apple_ptx_bridge/src/lib.rs"
...
check_text "$HETGPU_HEADER" "hetgpu_apple_ptx_module_load_data"
check_text "$HETGPU_HEADER" "hetgpu_apple_ptx_launch_kernel"
check_text "$HETGPU_STUB" "hetgpu_apple_ptx_module_load_data"
check_text "$HETGPU_STUB" "hetgpu_apple_ptx_register_allocation"
check_text "$APPLE_PTX_BRIDGE" "compile_ptx_to_msl_module"
check_text "$APPLE_PTX_BRIDGE" "hetgpu_apple_ptx_launch_kernel"
check_text "$APPLE_PTX_BRIDGE" "hetgpu_apple_ptx_register_allocation"
